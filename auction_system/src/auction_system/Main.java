...
//			loadData();
	...
	public void sellerListItem(Stage primaryStage) {
		try {
			...
			VBox biddingContent = new VBox(biddingLabel, itemNameField, bidderNameField, bidAmountField, placeBidButton, bidHistoryArea);
			biddingContent.setSpacing(10);
			biddingTab.setContent(biddingContent);
